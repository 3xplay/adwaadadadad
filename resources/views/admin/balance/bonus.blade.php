    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <div class="widget-two__icon b-radius--5 bg--primary">
                            <a href="{{ route('backoffice.balance.main', $saldo->id) }}"><i class="text-white las la-plus-circle"></i></a>
                        </div>
                        <div class="widget-two__content">
                            <a href="{{ route('backoffice.balance.main', $saldo->id) }}">
                                <h3 class="text-white">Tambah Saldo Utama</h3>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                <div class="flex-fill">
                    <a href="{{ route('backoffice.balance.main', $saldo->id) }}"><button
                            class="btn btn--success btn--shadow w-100 btn-lg h-45">
                            <i class="las la-plus-circle"></i> @lang('Tambah Saldo Utama')
                        </button></a>
                </div>
            </div>
            ...
            <div class="card mt-30">
                <div class="card-header">
                    <h5 class="card-title mb-0">@lang('Saldo Bonus') <strong>{{ $data_member->name }}</strong></h5>
                </div>
                <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group ">
                                        <select class="form-control" name="type" required>
                                            ...
                                            <option value="3"> Tambah Saldo Bonus </option>
                                            <option value="4"> Kurangi Saldo Bonus </option>
                                        </select>
                                    </div>
                                </div>
                            </div>
